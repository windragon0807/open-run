...
function CommonBadge() {
  return (
    <div className='bg-white px-8 py-2 rounded-4 mb-8 shadow-custom-white'>
...
function RareBadge() {
  return (
    <div className='relative bg-white pr-8 pl-10 py-0 rounded-4 mb-8 shadow-custom-white'>
...
function EpicBadge() {
  return (
    <div className='relative bg-white pl-10 pr-8 py-0 rounded-4 mb-8 shadow-custom-white'>
