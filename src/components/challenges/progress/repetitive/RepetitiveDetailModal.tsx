    ...
    <Dimmed onClick={() => closeModal(MODAL_KEY.REPETITIVE_CHALLENGE_DETAIL)}>
      <BottomSheet fullSize>
        <header className='relative flex h-60 w-full items-center justify-center px-16'>
          <span className='text-16 font-bold'>{challenge?.challengeName}</span>
          <button
          ...
          <>
            ...
            <section className='h-full bg-gray-lighten'>
              ...
              <div className='relative h-[calc(100%-336px)] overflow-y-auto'>
                <div className='flex flex-col gap-8 px-16 pb-40 pt-20'>
                  {stages.map((stage, index) => {
                ...
                {/* 하단 그라데이션 blur 효과 */}
                <div className='pointer-events-none sticky bottom-0 h-60 bg-gradient-to-b from-transparent via-gray-lighten/80 to-gray-lighten' />
              </div>
            </section>
          </>
        )}
